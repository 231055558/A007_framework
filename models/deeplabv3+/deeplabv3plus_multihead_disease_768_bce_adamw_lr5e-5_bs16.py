...
class DeepLabV3Plus_MultiHead_Disease_768_Bce_AdamW:
    def __init__(self):
        self.data_root = '../../../data/data_merge'
        self.pretrain_ckp = "./best_model.pth"

        self.model_name = 'DeepLabV3Plus_MultiHead_Disease_768_Bce_AdamW_Lr5e-5_Bs16'
...
if __name__ == '__main__':
    model = DeepLabV3Plus_MultiHead_Disease_768_Bce_AdamW()
    model.train(epoch=300)  # 训练模型
    # model.val()  # 验证模型
