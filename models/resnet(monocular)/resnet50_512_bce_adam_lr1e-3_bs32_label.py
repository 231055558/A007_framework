...
class ResNet50_512_Bce_Adam_Lr1e_3_Bs32_Label:
    def __init__(self):
        ...
        self.metric = A007_Metrics_Label(thresholds=[0.1, 0.3, 0.5, 0.7, 0.9], num_labels=8)
...
if __name__ == '__main__':
    model = ResNet50_512_Bce_Adam_Lr1e_3_Bs32_Label()
    # model.train()
    model.val()